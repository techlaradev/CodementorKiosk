        ...
        <div className="max-w-2xl space-x-20 flex">
          <Card className="bg-[#F8EACD] w-1/2">
            <CardHeader>
              ...
              <img className="w-[244px] h-[260px] origin-top-left rotate-0" src="https://via.placeholder.com/244x260" />
              <CardDescription>Por favor insira seu email e senha para logar!</CardDescription>

            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Input className="bg-[#E4C88C] rounded-xl" placeholder="Insira seu email aqui" required type="email" />
              </div>
              <div className="space-y-2">
                <Input
              ...
              <Button className="w-full mt-4 mb-17" variant="outline" color="#fffff">
                Login with Google
              </Button>
            </CardContent>
            <CardFooter>
              <Button className="w-full mt-2 bg-[#D9B56B] text-black">Sign in</Button>
            </CardFooter>
          </Card>
          <Card className="bg-[#F8EACD] w-1/2 ml-auto mr-10">
            <CardHeader>
              <CardTitle className="text-2xl"> É novo por aqui?</CardTitle>
              <CardTitle className="text-1xl">Cadastre-se agora mesmo</CardTitle>
